...
| 模块 | 说明 |
| --- | --- |
| `opensabre-starter-boot` | 基础启动、监控、链路追踪、校验、配置加密、脱敏；不传递 Servlet/OpenAPI UI |
| `opensabre-starter-webmvc` | Spring MVC、Undertow、统一响应/异常、Springdoc、Knife4j |
...
| `opensabre-starter-governance` | 审计日志、限次注解 SDK；审计通过 EDA 异步处理 |
